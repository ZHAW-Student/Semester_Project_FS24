...
```{r confusion matrix Sarahs data, message=FALSE, results='hide', fig.cap="Confusion matrix for Sarah's test data."}
...
```{r CAMA confusion matrix Saskias training data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's training data."}
...
```{r CAMA confusion matrix Saskias test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
```{r CAMA confusion matrix Sarahs test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Sarah's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
```{r CART confusion matrix Saskias training data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's training data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
```{r CART confusion matrix Saskias test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
```{r CART confusion matrix Sarahs test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Sarah's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
As described in a review by @pearson_systematic_2024 overall a lack in consensus for the optimal reporting of GPS data is present, with studies often missing to report noise. In our group project the exported data did not contain any information on GPS accuracy, which shows how unimportant this information is perceived. This information could have been used to improve our analysis by not only providing information about the reliability of the data but also to identify locations within a building. As @kim_new_2012 showed, the number of satellites can be used to asses whether a point was documented within a building. Another option to improve the differentiation between indoor and outdoor activities could be the use of the walking period duration and continuity as in @baroudi_classification_2024 or record density and heading changes as described in @berjisian_evaluation_2022. 

To conclude our analysis demonstrated the importance of context information in activity type detection. 
