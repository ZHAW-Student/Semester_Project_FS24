...
```{r confusion matrix Saskias data, message=FALSE, results='hide', fig.cap="Confusion matrix for the test data. "}
...
```{r confusion matrix Sarah's data, message=FALSE, results='hide', fig.cap="Confusion matrix for Sarah's test data."}
