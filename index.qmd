...
```{r confusion matrix, message=FALSE, results='hide', fig.cap="Confusion matrix for the training data. The overall accuracy is 59 %."}
...
```{r confusion matrix Saskias data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's data. The accuracy is 33 %. Most misclassifications occur with travel and recreation."}
...
```{r confusion matrix Sarah's data, message=FALSE, results='hide', fig.cap="Confusion matrix for Sarah's data."}
...
#### Training data Saskia
The overall accuracy with Saskia’s training data is 71%. The sensitivity (0.80) and detection rate (0.46) are highest for travel.
```{r CAMA confusion matrix Saskia's training data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's training data."}
...
#### Activity data Saskia
With Saskia’s test data the overall accuracy is 82%. The sensitivity (0.83) is highest for recreation and the detection rate (0.59) is highest for recreation as well.
```{r CAMA confusion matrix Saskia's test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
#### Activity data Sarah
The overall accuracy with Sarah’s activity data is 59%. With a sensitivity of 0.86 shopping is the most sensitive category. On the other hand the detection rate is highest for recreation (0.27).
```{r CAMA confusion matrix Sarah's test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Sarah's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
```{r CART tree based on Saskis's training data, message=FALSE, results='hide', fig.cap="Classification decision tree."}
...
With Saskia’s training data the overall accuracy is 77%. The most sensitive category is travel (0.79) and the highest detection rate is present for travel with (0.52).
```{r CART confusion matrix Saskia's training data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's training data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
```{r CART confusion matrix Saskia's test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Saskia's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
...
```{r CART confusion matrix Sarah's test data, message=FALSE, results='hide', fig.cap="Confusion matrix for Sarah's test data."}
#| code-summary: Confusion matrix Saskias training data
# plot confusion matrix
